...
3.Please download the latest Abelian Multi-layer Privacy Wallet(`abecwalletmlp`) (package [abewalletmlp-v1.0.1](/downloads/latest#abelian-multi-layer-privacy-wallet-cli)).
...
The following migration guide is based on the assumption you are using [**abewalletlegacy** with **version 1.0.0**](/downloads/latest#abelian-legacy-wallet-cli), possess assets, and have also reviewed the [Abelian Legacy Wallet CLI Manual](/guide/wallet/legacy-wallet-cli).

...
After getting the Abelian Lite CLI Wallet (/downloads/latest#abelian-lite-wallet-cli) in compressed form, unzip it. All the commands below can be typed and executed in Terminal (macOS / Linux) or PowerShell (Windows).
...
From [Abelian Lite Wallet Download Page](/downloads/latest#abelian-lite-wallet-cli), you can download a pre-configured **abewallet.conf**. Below are the details of configuring **abewallet.conf**.
...
This full node RPC certificate can be downloaded from [Abelian Lite Wallet Download Page](/downloads/latest#abelian-lite-wallet-cli). It is packed in a folder called **abec_certs/**. For example, we may put this folder in ```~/Documents/``` and set the **cafile** in **abewallet.conf** as
```
...
All these certificates are packed in the folder called **abec_certs/** and its compressed form can be downloaded from [Abelian Lite Wallet Download Page](/downloads/latest#abelian-lite-wallet-cli).

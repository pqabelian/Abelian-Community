...
3.请下载最新的Abelian多层隐私钱包（CLI）(`abecwalletmlp`)（软件包 [abewalletmlp-v1.0.1](/zh/downloads/latest#abelian-多层隐私钱包-cli)）
...
接下来的迁移操作指南，是假设您已使用[**abewalletlegacy 版本 1.0.0**](/zh/downloads/latest#abelian-传统钱包-cli) 并拥有资产，且按照 [Abelian 传统钱包 (CLI) 手册](/zh/guide/wallet/legacy-wallet-cli) 进行`abewalletlegacy`正常使用

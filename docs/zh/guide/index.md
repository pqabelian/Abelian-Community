...
如果你只是想运行一个安全且用户友好的 Abelian 钱包，并带有一个漂亮的用户界面，你可以直接访问 Abelian 官方下载页面，获取 [Abelian 桌面钱包](/zh/downloads/latest#abelian-桌面钱包-传统版) 安装包。
...
[Abelian 官方下载页面](/downloads/latest)。要与其他矿工、开发者和用户互动，请访问 [官方 Discord 服务器](https://discord.com/invite/5rrDxP29hx)。
